...
Книга статей, которую не удалось прочитать, попадает в тот же перечень, что и
отсутствующая: её статьи не индексируются, остальные книги и книга карточек —
индексируются. Файл книги, который не читается, не декодируется или не
разбирается, теряет только себя.
